...
import xchaingeAbi from "../constants/Dolx.json"
import xchaingeTokenAbi from "../constants/DolxToken.json"
...
const SellNft: NextPage = () => {
  ...
  const xchaingeAddress = (networkMapping as NetworkConfigMap)[chainString]
    .Dolx[0]
  const xchaingeTokenAddress = "0xd754f45154B772f1988Bb4bB5b0488EB955a7b37"
